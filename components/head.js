...
export default function Head() {
    ...
    return(
        <NextHead>
            ...
            />
            <script src="https://config.metomic.io/config.js?id=prj:e114b29d-6a87-4a11-bd0f-28df9df2e9e1" crossOrigin="true" charSet="utf-8"></script>
            <script src="https://consent-manager.metomic.io/embed.js" crossOrigin="true" charSet="utf-8"></script>
