...
const HowToSurveys = () => {
    ...
    const changeImage = () => {
        ...
        if (tab === 2) { return "/static/images/survey_insights.svg" }
        if (tab === 3) { return "/static/images/survey_audiences.svg" }
    }
